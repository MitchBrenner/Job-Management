...
public class Application implements Comparable<Application>{
  ...
  public Application(String name, String email, int score) {
    ...
    // ... or if the provided email is null, or has none or multiple @
    if(email == null || email.equals("")) throw new IllegalArgumentException("Invalid Email");
    int numAts = 0;
    ...
    if(numAts != 1) throw new IllegalArgumentException("Invalid Email");
